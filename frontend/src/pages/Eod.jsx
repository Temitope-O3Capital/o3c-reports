...
const CHIP_DR  = { display: 'inline-flex', alignItems: 'center', gap: 5, height: 34, padding: '0 12px', borderRadius: 8, border: '1px solid', fontSize: 13, fontWeight: 500, cursor: 'pointer', transition: 'all 0.12s', userSelect: 'none', outline: 'none', background: '#FEF2F2', color: '#C00000', borderColor: '#FECACA' }
const CHIP_CR  = { display: 'inline-flex', alignItems: 'center', gap: 5, height: 34, padding: '0 12px', borderRadius: 8, border: '1px solid', fontSize: 13, fontWeight: 500, cursor: 'pointer', transition: 'all 0.12s', userSelect: 'none', outline: 'none', background: '#F0FDF4', color: '#059669', borderColor: '#BBF7D0' }
