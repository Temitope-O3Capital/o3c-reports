export default function MobileApp() {
  return (
    <div className="px-6 py-7 lg:px-8 lg:py-8 max-w-[1440px] mx-auto animate-fade-in">
      <div className="mb-6">
        <h1 className="text-xl font-semibold text-slate-900 dark:text-white">Mobile App Report</h1>
        <p className="text-sm text-slate-500 mt-0.5">App engagement, onboarding, and usage analytics</p>
      </div>
      <div className="card p-12 flex flex-col items-center justify-center gap-4 text-center">
        <div className="w-16 h-16 rounded-2xl flex items-center justify-center" style={{ background: '#F0FDF4' }}>
          <span className="material-symbols-rounded text-[32px]" style={{ color: '#059669' }}>phone_android</span>
        </div>
        <div>
          <p className="text-base font-semibold text-slate-800 dark:text-slate-100">Mobile App Report</p>
          <p className="text-sm text-slate-400 mt-1 max-w-sm">
            Coming soon — mobile app analytics including installs, active users, and feature adoption metrics.
          </p>
        </div>
