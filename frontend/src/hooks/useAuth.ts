...
export const ROLE_PAGES: Record<string, string[]> = {
  ...
  bi_head: ['cohort', 'executive', 'kpi_dashboard', 'overview', 'reports', 'statements', 'uploads'],
  call_center_agent: ['call_center', 'crm_contacts', 'customer360', 'helpdesk', 'helpdesk_canned', 'helpdesk_kb', 'overview'],
  call_center_head: ['call_center', 'call_center_stats', 'campaigns', 'contact_lists', 'crm_contacts', 'customer360', 'executive', 'helpdesk', 'helpdesk_canned', 'helpdesk_kb', 'helpdesk_stats', 'kpi_dashboard', 'message_templates', 'overview', 'statements', 'surveys', 'uploads'],
  cards_agent: ['blink_card', 'card_trends', 'cards', 'customer360', 'helpdesk', 'helpdesk_canned', 'helpdesk_kb', 'los_booking', 'overview'],
  cards_head: ['blink_card', 'card_trends', 'cards', 'customer360', 'executive', 'helpdesk', 'helpdesk_canned', 'helpdesk_kb', 'kpi_dashboard', 'los_assign', 'los_booking', 'mobile_app', 'overview', 'statements', 'surveys', 'uploads'],
  care_agent: ['care', 'crm_contacts', 'customer360', 'helpdesk', 'helpdesk_canned', 'helpdesk_kb', 'overview', 'surveys'],
  care_head: ['care', 'crm_contacts', 'customer360', 'executive', 'helpdesk', 'helpdesk_canned', 'helpdesk_kb', 'helpdesk_stats', 'kpi_dashboard', 'message_templates', 'overview', 'statements', 'surveys', 'uploads'],
  cfo: ['approvals', 'collections', 'collections_payment', 'collections_payment_approve', 'core-banking', 'credit_portfolio', 'customer360', 'eod', 'executive', 'finance', 'fixed_deposit', 'fx_rates', 'income', 'kpi_dashboard', 'los_finance', 'los_finance_approve', 'overview', 'payroll', 'reconciliation', 'recovery', 'recovery_write_off', 'settlement', 'statements', 'transactions', 'uploads'],
  cmo: ['bd', 'bd_employers', 'bd_pipeline', 'campaigns', 'cohort', 'contact_lists', 'crm_contacts', 'crm_pipeline', 'crm_reports', 'crm_tasks', 'customer360', 'executive', 'kpi_dashboard', 'loans', 'los', 'mail', 'message_templates', 'overview', 'sales', 'surveys', 'uploads'],
  ...
  collections_head: ['collections', 'collections_assign', 'collections_payment', 'collections_payment_approve', 'credit_portfolio', 'crm_contacts', 'customer360', 'executive', 'kpi_dashboard', 'loans', 'overview', 'recovery', 'statements', 'surveys', 'uploads'],
  compliance_head: ['audit_export', 'audit_findings', 'audit_trail', 'cbn_reports', 'compliance_all', 'compliance_checklists', 'customer360', 'executive', 'kpi_dashboard', 'overview', 'sars', 'uploads', 'watch_list'],
  ...
  finance_head: ['core-banking', 'credit_portfolio', 'customer360', 'eod', 'executive', 'finance', 'fixed_deposit', 'fx_rates', 'helpdesk', 'helpdesk_canned', 'helpdesk_kb', 'income', 'kpi_dashboard', 'los_finance', 'los_finance_approve', 'overview', 'payroll', 'reconciliation', 'settlement', 'statements', 'transactions', 'uploads'],
  ...
  head_ops: ['approvals', 'blink_card', 'call_center', 'call_center_stats', 'card_trends', 'cards', 'care', 'collections', 'collections_assign', 'collections_payment', 'collections_payment_approve', 'credit_portfolio', 'crm_contacts', 'customer360', 'executive', 'helpdesk', 'helpdesk_canned', 'helpdesk_kb', 'helpdesk_stats', 'kpi_dashboard', 'loans', 'mobile_app', 'overview', 'reconciliation', 'recovery', 'recovery_assign', 'recovery_write_off', 'settlement', 'statements', 'surveys', 'uploads'],
  ...
  recovery_head: ['credit_portfolio', 'customer360', 'executive', 'kpi_dashboard', 'loans', 'overview', 'recovery', 'recovery_assign', 'recovery_write_off', 'statements', 'uploads'],
  ...
  sales_head: ['campaigns', 'cohort', 'contact_lists', 'crm_contacts', 'crm_pipeline', 'crm_reports', 'crm_tasks', 'customer360', 'executive', 'kpi_dashboard', 'loans', 'los', 'los_all', 'los_assign', 'mail', 'message_templates', 'overview', 'sales', 'statements', 'uploads'],
